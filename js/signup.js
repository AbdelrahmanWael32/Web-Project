...
const passwordErrorDontMatch = document.getElementById(
  "password-error-dont-match",
);
const passwordErrorLessThanRequired = document.getElementById(
  "password-error-less-than-required",
);
