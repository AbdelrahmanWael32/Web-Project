...
//   recipes.forEach(({ id, name, course_type, cooking_time, difficulty }) => {
//     let recipe = `
// <a href="./recipe1.html">
...
//     const matches = recipe.name.toLowerCase().includes(searchTerm);
//     console.log('Checking recipe:', recipe.name, 'Matches:', matches);
//     return matches;
//   });
...
function renderRecipes(recipes) {
  ...
  const html = recipes.map(({ id, name, course_type, cooking_time, difficulty }) => `
    <a href="./recipe1.html">
      <div class="recipe-box flexbox flex-column justify-between">
        <div class="flexbox flex-column">
          <img
